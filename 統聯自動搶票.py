...
s = Service(r"C:\Users\AOE\Desktop\chromedriver.exe")
...
driver.find_element(By.NAME,'MemberID').send_keys('帳號')
...
driver.find_element(By.CSS_SELECTOR,'#AA').click()
